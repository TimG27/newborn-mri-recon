"""
This file runs a testing loop on the newborn dataset
"""
...
valid_data = SliceSmapDataset(slice_ids, 'valid', smaps, masks, 'espirit', coils, data_transforms=test_transforms, target_transforms=test_transforms)
